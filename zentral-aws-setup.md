...
4. The `setup.py` script will generate a TLS certificate from Let's Encrypt and provide a https link at the end to initally set (reset) the password for the superuser to login.
